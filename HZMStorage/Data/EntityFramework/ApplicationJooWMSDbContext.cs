...
{
    public partial class ApplicationJooWMSDbContext : DbContext
    {

        public ApplicationJooWMSDbContext(DbContextOptions<ApplicationJooWMSDbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=iupdate.online; Initial Catalog=JooWMS; Persist Security Info=True; User ID=sa; Password=Abc123456;");
            }
        }
